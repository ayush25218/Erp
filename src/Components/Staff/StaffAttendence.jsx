...
import { FaUserCheck, FaUserTimes, FaUserSlash, FaUser, FaCheckCircle } from 'react-icons/fa';
import moment from 'moment';

// Dummy data for non-teaching staff members
const staffData = [
    { id: 1, name: 'Ramesh Kumar', department: 'Administration' },
    { id: 2, name: 'Sunita Rai', department: 'Library' },
    { id: 3, name: 'Alok Singh', department: 'IT' },
    { id: 4, name: 'Priya Mehta', department: 'Front Desk' },
    { id: 5, name: 'Vikram Patel', department: 'Sports' },
    { id: 6, name: 'Geeta Sharma', department: 'Security' },
];
    ...
    return (
        <div style={styles.container}>
            <motion.div variants={containerVariants} initial="hidden" animate="visible" style={styles.card}>
                <h1 style={styles.header}>Non-Teaching Staff Attendance</h1>
                <p style={styles.subheading}>Mark and manage daily attendance for all non-teaching staff members.</p>
                    ...
                    <div style={styles.tableContainer}>
                        <table style={styles.table}>
                            ...
                            {loading ? (
                                ...
                                staffData.map(staff => {
                                    const status = currentDayAttendance[staff.id] || '';
                                    return (
                                        <motion.tr
                                            key={staff.id}
