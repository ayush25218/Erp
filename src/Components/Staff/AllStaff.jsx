...
import { FaSearch, FaUserCircle, FaEnvelope, FaPhone, FaTimes, FaBriefcase, FaBuilding } from 'react-icons/fa';
...
const staffData = [
    {
        ...
        bio: 'Manages all financial transactions and bookkeeping for the school.',
    },
    {
        id: 2,
        name: 'Sunita Rai',
        ...
        bio: 'Oversees the school library, manages book circulation, and helps students with research.',
    },
    {
        id: 3,
        name: 'Alok Singh',
        ...
        bio: 'Provides technical support for all school hardware and software, ensuring smooth IT operations.',
    },
    {
        id: 4,
        name: 'Priya Mehta',
        ...
        bio: 'First point of contact for visitors and parents. Manages inquiries and administrative tasks.',
    },
    {
        id: 5,
        name: 'Vikram Patel',
        ...
        bio: 'Trains students for various sports and organizes inter-school tournaments.',
    },
];
        ...
        <div style={styles.container}>
            <motion.div variants={containerVariants} initial="hidden" animate="visible">
                <div style={styles.header}>
                    <h1 style={styles.title}>All Staff</h1>
